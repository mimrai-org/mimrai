...
const inputVariants = cva("", {
	variants: {
		variant: {
			...
			ghost:
				"flex h-9 w-full min-w-0 rounded-sm bg-transparent px-3 py-1 text-base outline-none transition-[color,box-shadow] transition-colors selection:bg-primary selection:text-primary-foreground file:inline-flex file:h-7 file:border-0 file:bg-transparent file:font-medium file:text-foreground file:text-sm placeholder:text-muted-foreground hover:bg-accent hover:text-accent-foreground focus:border focus:bg-transparent disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 md:text-sm dark:bg-input/30 dark:bg-transparent dark:aria-invalid:ring-destructive/40 dark:hover:bg-accent/50",
		},
	},
	defaultVariants: {
		variant: "outline",
